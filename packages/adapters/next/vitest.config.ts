...
export default defineConfig({
    resolve: {
        alias: {
            ...
            '@danceroutine/tango-orm/transaction': resolve(__dirname, '../../orm/src/transaction/index.ts'),
            '@danceroutine/tango-orm/runtime': resolve(__dirname, '../../orm/src/runtime/index.ts'),
            '@danceroutine/tango-orm/manager': resolve(__dirname, '../../orm/src/manager/index.ts'),
